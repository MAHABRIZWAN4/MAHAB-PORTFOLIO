        ...
        <>
          ...
          <div className="fixed inset-0 z-[101] flex items-center justify-center p-4">
            <motion.div
              ...
              className="relative w-full max-w-[480px] rounded-2xl p-8 bg-white dark:bg-gray-900 border border-indigo-200 dark:border-indigo-400/50 shadow-2xl"
              style={{
                boxShadow: isDark
                  ? "0 0 80px rgba(99,102,241,0.4), 0 20px 60px rgba(0,0,0,0.5)"
                ...
                {options.map((option, index) => {
                  ...
                  return (
                    <motion.a
                      ...
                      className="group flex items-center gap-4 p-4 rounded-xl transition-all duration-300 cursor-pointer bg-gray-50 dark:bg-white/10 border border-gray-200 dark:border-white/20 hover:border-indigo-400 dark:hover:border-indigo-400 hover:shadow-md"
                    >
                      {/* Icon */}
                      <div className="flex-shrink-0 w-12 h-12 rounded-lg flex items-center justify-center bg-indigo-100 dark:bg-indigo-500/30 text-indigo-600 dark:text-indigo-300">
                        <Icon size={24} />
                      </div>
                      ...
                      <ArrowRight
                        size={20}
                        className="text-gray-400 dark:text-gray-400 group-hover:text-indigo-600 dark:group-hover:text-indigo-300 transition-colors"
                      />
                    </motion.a>
                  );
                })}
